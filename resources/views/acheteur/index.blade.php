    ...
    <div class="col-lg-12 mt-5 mt-lg-0 col-md-12 text-primary mx-auto border-bottom py-1">
        <nav class="nav-wrapper ">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row " id="tabs-text">
                <li class="nav-item">
                    <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-text-1-tab" href="{{ route('acheteur.index') }}"><i
                ...
                <div class="card col-12 mx-2 p-1 rounded">
                    ...
                    <div class="card-body bg-light m-0">
                        ...
                        <div class="float-right pt-2">
                            <a target="_blank" href="{{'acheteur/offres/'.$appel_offre->id}}" class=" btn btn-sm  btn-outline-success text-decoration-none "><i
                                class="fa fa-cubes mr-2"></i>Offres</a>
                            <a target="_blank" href="{{'acheteur/reglement/'.$appel_offre->id}}" class=" btn btn-sm  btn-outline-primary text-decoration-none "><i
                                    ...
                                    <a href="{{'acheteur/appeloffres/delete/'.$appel_offre->id}}" onclick="return confirm('Voulez vous supprimé cette appel d\'offre ?')" class=" btn btn-sm  btn-outline-danger text-decoration-none "><i
                                        class="fa fa-times mr-2"></i>Supprimer</a>
